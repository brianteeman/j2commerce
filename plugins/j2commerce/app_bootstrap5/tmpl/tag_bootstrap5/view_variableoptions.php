    ...
    <?php foreach ($options as $option) : ?>
        ...
        <?php if ($option['type'] === 'select' && !empty($option['optionvalue'])) : ?>
            <div id="option-<?php echo $option['productoption_id']; ?>" class="option mb-3">
                ...
                <select<?php echo ProductLayoutService::optionDescribedBy($option); ?> name="product_option[<?php echo $option['productoption_id']; ?>]"
        ...
        <?php if ($option['type'] === 'radio' && !empty($option['optionvalue'])) : ?>
            <fieldset id="option-<?php echo $option['productoption_id']; ?>" class="option mb-3 j2commerce-option-group"<?php echo ProductLayoutService::optionDescribedBy($option); ?>>
        ...
        <?php if ($option['type'] === 'textarea') : ?>
            <div id="option-<?php echo $option['productoption_id']; ?>" class="option mb-3">
                ...
                <textarea<?php echo ProductLayoutService::optionDescribedBy($option); ?> id="option-textarea-<?php echo $option['productoption_id']; ?>"
                          class="form-control"
                          name="product_option[<?php echo $option['productoption_id']; ?>]"
