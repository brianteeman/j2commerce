...
(5, 'address', 'J2COMMERCE_ADDRESS_LINE2', 'address_2', 'text', '', 1, 2, '{"field_collapse_toggle":1}', 1, 0, '', 'J2COMMERCE_PLACEHOLDER_ADDRESS_2', 'address-line2', 'col-12', 'all', 'all', 0, 0, 1, '', 1, 1, 1, 1, 1, 0),
...
CREATE TABLE IF NOT EXISTS `#__j2commerce_orders` (
  ...
  `order_state` varchar(255) NOT NULL DEFAULT '' COMMENT 'Legacy compatibility - no longer written by core; use order_state_id',
